...
conn.sendMessage(id, 'ulangi dengan  p$ict cewek/cowok\n\nMisal: $pict cowok' ,MessageType.text);
}
...
if (text.includes("$pokemon"))

   {
    ...
    var url = "https://assets.pokemon.com/assets/cms2/img/pokedex/full/'+q7+'.png','Pokemon.png";
